...
public class NewBehaviourScript1 : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(100, 100, 400, 100), "Update: " + updateUpdateCountPerSecond.ToString(), fontSize);
        GUI.Label(new Rect(100, 200, 400, 100), "FixedUpdate: " + updateFixedUpdateCountPerSecond.ToString(), fontSize);
    }
